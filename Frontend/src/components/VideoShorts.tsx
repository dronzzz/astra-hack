        ...
        {shorts.map((short, index) => (
          ...
          >
            <div className="max-w-[300px] mx-auto w-full">
              {/* Very basic video display with direct file paths */}
              <div className="relative aspect-[9/16] bg-ai-dark overflow-hidden">
                {/* Simple directly embedded video */}
                <video
                  src={short.url}
              ...
              <div className="p-2">
                ...
                <a
                  href={short.url}
                  download
                  className="mt-2 w-full block text-center px-2 py-1 bg-ai-accent text-white text-xs rounded hover:bg-ai-accent/80"
                >
                  Download Video
                </a>
              </div>
